...
for epoch in range(80) :
    ...
    if (epoch+1) % 10 == 0 :
        backbone.save_weights("/home/barrage/grp3/models/alvin/backbone_600_adv_reas"+str(epoch)+"_t01.weights.h5")
        mlp.save_weights("/home/barrage/grp3/models/alvin/mlp_600_adv_reas"+str(epoch)+"_t01.weights.h5")
        print("JE SAVE")
        if epoch == 20 :
            temp = 0.8
        if epoch == 40 :
...
backbone.save_weights("/home/barrage/grp3/models/alvin/backbone_600_adv_reas_t01.weights.h5")
mlp.save_weights("/home/barrage/grp3/models/alvin/mlp_600_adv_reas_t01.weights.h5")
