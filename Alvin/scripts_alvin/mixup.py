...
class RaggedGenerator(keras.utils.Sequence) :
    ...
    def __getitem__(self, idx):
        ...
        apply = np.random.random((self.batch_size)) > 0.6
...
#backbone.load_weights("/home/barrage/grp3/models/alvin/backbone_600_adv_t01.weights.h5")
...
for epoch in range(50) :
    ...
    for batch in generator :
        ...
        acc.update_state(tf.argmax(batch["train_labels"], axis=1), predictions)
    ...
    if (epoch+1) % 10 == 0 :
        backbone.save_weights("/home/barrage/grp3/models/alvin/backbone_mixup_"+str(epoch+1)+".weights.h5")
        mlp.save_weights("/home/barrage/grp3/models/alvin/mlp_mixup_"+str(epoch+1)+".weights.h5")
        adv.save_weights("/home/barrage/grp3/models/alvin/advmlp_mixup_"+str(epoch+1)+".weights.h5")
...
backbone.save_weights("/home/barrage/grp3/models/alvin/backbone_mixup.weights.h5")
mlp.save_weights("/home/barrage/grp3/models/alvin/mlp_mixup.weights.h5")
adv.save_weights("/home/barrage/grp3/models/alvin/advmlp_mixup.weights.h5")
...
df.to_csv("result_mixup.csv", index=False)
