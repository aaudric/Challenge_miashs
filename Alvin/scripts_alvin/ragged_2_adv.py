...
for epoch in range(80) :
    ...
    if (epoch+1) % 10 == 0 :
        backbone.save_weights("/home/barrage/grp3/models/alvin/backbone_600_adv_"+str(epoch+50)+"_t01.weights.h5")
        mlp.save_weights("/home/barrage/grp3/models/alvin/mlp_600_adv_"+str(50)+"_t01.weights.h5")
        print("JE SAVE")
        if epoch == 20 :
            temp = 0.4
        if epoch == 40 :
...
df.to_csv("result_adv_600_t01.csv", index=False)
