...
for epoch in range(50) :
    ...
    for batch in generator :
        ...
        with tf.GradientTape() as tape :
            ...
            loss_classif = tf.reduce_mean(tf.keras.losses.KLDivergence()(batch["train_labels"], predictions))
    ...
    if epoch % 10 == 0 :
        backbone.save_weights("backbone_kl_"+str(epoch)+".weights.h5")
        mlp.save_weights("mlp_kl_"+str(epoch)+".weights.h5")
        print("JE SAVE")


backbone.save_weights("backbone_kl.weights.h5")
mlp.save_weights("mlp_kl.weights.h5")





#backbone.load_weights("./backbone_adv.weights.h5")
#mlp.load_weights("./mlp_adv.weights.h5")
